...
const char* GetOpName(opcodetype opcode)
{
    ...
    // stack ops
    case OP_TOALTSALTK             : return "OP_TOALTSALTK";
    case OP_FROMALTSALTK           : return "OP_FROMALTSALTK";
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // Altcoin address tx, sender provides hash of pubkey, receiver provides signature and pubkey
